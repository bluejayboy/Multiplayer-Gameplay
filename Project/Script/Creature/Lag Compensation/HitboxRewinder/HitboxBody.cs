...
namespace Hitbox
{
    ...
    public class HitboxBody : MonoBehaviour
    {
        ...
        public Vector3 BoundsCenter { get { return _bounds.center; } set { _bounds.center = value; } }
        public Vector3 BoundsExtent { get { return _bounds.extents; } set { _bounds.extents = value; } }

        [SerializeField] private Transform[] _transforms;
        public Transform[] Transforms { get { return _transforms; } set { _transforms = value; } }
        public int CurrentSnapshotFrame { get; private set; }
