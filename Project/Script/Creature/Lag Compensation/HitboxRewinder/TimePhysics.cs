...
namespace Hitbox
{
    public static class TimePhysics
    {
        ...
        public static int WorldFrame { get; private set; }
        ...
        public static RewindState RewindWorld(int frame, HitboxBody ignore = null)
        {
            return new RewindState(frame, ignore);
        }

        public static RewindState RewindFrames(int frames, HitboxBody ignore = null)
        {
            return new RewindState(WorldFrame - frames, ignore);
        }

        public static RewindState RewindSeconds(float seconds, HitboxBody ignore = null)
        {
            return new RewindState(seconds, ignore);
        }
        ...
        public struct RewindState : IDisposable
        {
            ...
            private static bool IsFrameRewindValid(int frame)
            {
                return frame >= WorldFrame - NumSnapshots;
            }

            private static bool IsLerpRewindValid(float lerpFrame)
            {
                return lerpFrame >= WorldFrame - NumSnapshots;
            }
        ...
        public static TimePhysicsClock Clock
        {
            get
            {
                return _clock ?? (_clock = Object.FindObjectOfType<TimePhysicsClock>() ?? GetNewInstance());
            }
        }
