...
namespace Scram
{
    ...
    public sealed class PlayerThirdPersonView : EntityBehaviour<IPlayerState>
    {
        ...
        [SerializeField] private bool isSpectate = false;
        ...
        private void ApplyPitch()
        {
            ...
            {
                if (isSpectate)
                    cachedTransform.localRotation = Quaternion.Euler(-state.Pitch, 0.0f, 180.0f);
                else
